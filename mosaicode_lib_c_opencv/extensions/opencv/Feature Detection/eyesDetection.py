...
# -*- coding: utf-8 -*-
"""
This module contains the EyesDetection class.
"""

from mosaicode.GUI.fieldtypes import *
from mosaicode.model.blockmodel import BlockModel

class EyesDetection(BlockModel):
	"""
	This class contains methods related the EyesDetection class.
	"""
...
"""		
	if(!$port[input_image]$.empty()){
		...
		cascade_$id$.detectMultiScale(tmp_$id$, $port[output_rects]$, 1.1, 3, 0|CV_HAAR_SCALE_IMAGE, Size(20, 20));
