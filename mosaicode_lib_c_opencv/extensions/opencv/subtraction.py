...
<<<<<<< HEAD:mosaicode_c_opencv/extensions/opencv/subtraction.py
...
"""
        self.codes["execution"] = \
            ...
            '$port[second_image]$, $port[output_image]$);\n' + \
            'cvSub($port[first_image]$, ' + \
            '$port[second_image]$, $port[output_image]$,0);\n' + \
            'cvResetImageROI($port[output_image]$);\n' + \
            '}\n'

>>>>>>> 87a6ee2e71fd3c9109e8972fc940e17d33a91064:mosaicode_lib_c_opencv/extensions/opencv/subtraction.py
# -----------------------------------------------------------------------------
